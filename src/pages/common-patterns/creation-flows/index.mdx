...
<Row>
  <Column colMd={6} colLg={6} className="ide-image--white-border">
...
<Row>
  <Column colLg={8} className="ide-image--white-border">
...
<Row>
  <Column colMd={4} colLg={4} className="ide-image--white-border">
