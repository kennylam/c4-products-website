...
<Caption>Example of empty state when a table has not been populated yet</Caption>
...
<Caption>Example of an empty state when a slide-over panel hasn't been populated yet</Caption>
