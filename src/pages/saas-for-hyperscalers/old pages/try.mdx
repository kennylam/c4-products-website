...
<AnchorLinks>
  ...
  <AnchorLink>Registration for IBM Cloud Try offers</AnchorLink>
  <AnchorLink>IBM Cloud registration right panel</AnchorLink>
  <AnchorLink>IBM Cloud registration security and account verification</AnchorLink>
...
<CardGroup>
  ...
  <MiniCard
    ...
    href="https://urx-perform.dal1a.cirrus.ibm.com/"
    actionIcon="launch"
  ></MiniCard>
</CardGroup>
...
**Important:** You can use [IBM PerForm](https://urx-perform.dal1a.cirrus.ibm.com) to build and manage URX Trial forms.
...
- The list items must explain the benefits of using the trial.
...
At IBM we offer three different types of product trial offerings. There are three possible trial formats offered at IBM: Trial, Sandbox Trial, and Freemium. Your product team may offer one type of trial, or a combination of multiple Try experiences. The right approach must ultimately depend on your product, your users, and your business priorities. Therefore, the type of information that you add to the trial landing page will also differ based on the type of trial your product team chooses. 
...
Here is an example of how the benefits of a product are used to populate the content for the left hand panel. You can see the closeness of benefits between the product marketing page and URX left hand panel for IBM API Connect. Though not 1:1, the items relevant to the trial have been carried over. Product teams are encouraged to follow this process when creating the content for the left hand panel. 
...
<CardGroup>
  <MiniCard
    title="Figma template"
    href="https://www.figma.com/file/7Vg0oWF2xBQzsimgJJZVcq/Template---Empty-state?type=design&node-id=1-116500&mode=design&t=Dln0DPXw8HeiJtJU-0"
    actionIcon="launch"
  ></MiniCard>
</CardGroup>


## Registration for IBM Cloud Try offers
This flow allows product teams to create IBM Cloud registration flow for Try offers and allows end users to sign up for a Sandbox Trial, Trial, or Freemium account for products that are provisioned on IBM Cloud. It will require users to create an IBM Cloud account when they sign up, unless they already have one.

### Navigating to the Try offer sign-up page
Users may navigate to the IBM Cloud registration form for Try offers. There are multiple ways a user can navigate to a Try experience; the most common is from the marketing site, where users can click on a CTA on the homepage, navigation, or interior site pages (such as Pricing and Industries). 

<Row>
  <Column colMd={8} colLg={10}>

![IBM Cloud Try offer page](images/ibmcloud-reg/ibmcloud-cta.png)
...
![IBM Cloud annotated page](images/ibmcloud-reg/ibmcloud-annotated.png)
...
## IBM Cloud registration right panel
...
![IBM Cloud Registration](images/ibmcloud-rightside/cloudr-rightside.png)

  </Column>
</Row>

### Best practices for creating a successful IBM Cloud registration right panel
...
## IBM Cloud registration security and account verification 
...
![IBM Cloud secure and verify](images/ibmcloud-secureverify/cloud-paymethod.png)
