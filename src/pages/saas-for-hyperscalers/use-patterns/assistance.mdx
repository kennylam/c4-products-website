...
<Breadcrumb>
  ...
  <BreadcrumbItem isCurrentPage href="https://pages.github.ibm.com/CDAI-design/cpp-foundation-microsite/saas-for-hyperscalers/use-patterns/assistance">
   Assistance
  </BreadcrumbItem>
</Breadcrumb>
...
4. **Additional support:** Easy access to other support links such as to the product online documentation and the ability to submit a ticket.
