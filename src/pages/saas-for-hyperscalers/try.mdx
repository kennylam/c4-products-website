...
**Important:** You can use [PerForm](https://urx-perform.dal1a.cirrus.ibm.com) to build and manage URX Trial forms.
...
- The use of additional content beyond bullet points such as images, badges, or animated GIFs is not permitted in URX left hand panels, and cannot be added using the [PerForm](https://urx-perform.dal1a.cirrus.ibm.com) tool.
