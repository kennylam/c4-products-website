...
![URX Logout](images/URX-Logout/logout-page.png)
...
Here is an example of how the benefits of a product are used to populate the content for the left hand panel. You can see the closeness of benefits between the product marketing page and URX left hand panel for API Connect. Though not 1:1, the ones that make sense have been carried over. Product teams are encouraged to follow this process when creating the content for the left hand panel. 

** API Connect: benefits **
<Row>
...
** API Connect: left hand panel information **
<Row>
