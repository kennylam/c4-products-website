...
<Breadcrumb>
  ...
  <BreadcrumbItem isCurrentPage href="https://pages.github.ibm.com/CDAI-design/cpp-foundation-microsite/saas-for-hyperscalers/common-patterns/trial-end">
   Expired trial
  </BreadcrumbItem>
</Breadcrumb>
...
## Email communication
In addition to the in product experience, emails can also be sent directly to the user both prior to the expiry and when the trial has expired. See [email templates](https://pages.github.ibm.com/CDAI-design/cpp-foundation-microsite/saas-for-hyperscalers/email-templates/) for details.
...
## Related
- [Trial countdown](https://pages.github.ibm.com/CDAI-design/cpp-foundation-microsite/foundational-experiences/trial-countdown/)
