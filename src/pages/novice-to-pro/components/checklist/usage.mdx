...
This component exists to facilitate onboarding experiences, and provide users a place to find recommended learning material.
...
3. **Checklist progress:** This is where you display completion progress value represented in the progress donut.
...
7. **Task name:**  The name of the task should be brief and clear and is limited to two lines. 
...
The section label should be brief, direct and summarize the tasks within it. It should not exceed 1-2 lines. A checklist should have section labels if the tasks listed can be grouped into smaller, more digestible sections based on their topics. 
