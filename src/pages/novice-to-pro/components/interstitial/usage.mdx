...
Interstitial screens can be a full page or an overlay and are shown the first time a user accesses a new experience 
(e.g. upon first log-in or the first time opening a page where a newly purchased capability is presented).
...
2. **Progress indicator (optional):** If the interstitial use steps, use the progress indicator to show the user where they are in the flow.
...
The illustration should always sit on the right side of the text. The footer (which contains the buttons) should expand 
...
#### Body content
The body content should contain information that provides additional detail or context to the heading, without repeating the heading itself. The full page should aim to build the user’s anticipation and pique their interest in what they will be able to do with the product. For the overlay, it should be direct and succinct regarding what the user needs to know or do when they access the page.


## Illustrations

Illustrations within interstitial screens visually enhance the content of the page and should help highlight the value (for full page) or reinforce the 
