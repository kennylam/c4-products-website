...
- When the level of detail or the amount of context needed on a topic will vary across users and you don’t want to over-explain to 
more mature users. 
...
- Do not use inside interstitial pages where content is meant to be a brief introduction of the value of the 
...
it from the rest of the content and to maintain connection with the key word. Only the first indented level of key word context can contain 
