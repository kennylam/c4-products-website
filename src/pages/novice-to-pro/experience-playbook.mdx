...
- Consider the explainability of what the system is doing so that the user can build trust in the product.
...
Once you have mapped out your flow, invite key stakeholders from your product team to a workshop. Include product management, technical SMEs, content creators, design research, support, and technical sales.
...
Ask product managers and user-focused SMEs to vote on the most impactful epics and stories to get the user to realize the value propositions. Once you have your prioritized epics and stories, outline the ideal to-be scenario. Highlight the milestones that the user is reaching with your interventions and where they’re achieving the value propositions.

## Create the curriculum

The key component of the novice to pro experience is the learning content itself — the success of the learning experience hinges on this. Before creating the curriculum, it’s important to understand the user’s learning style and motivations as well as identify the level of detail needed.
...
- Understand the day-in-a-life of your users and where learning fits into it
- Understand the ways your users learn and engage with learning
- Understand the level of detail required for your users when learning
- Understand the user’s motivations to learn
- Establish the maturity of your users

#### Script and setup

- Allow some time for the user to talk about themselves, their job, their company, and thier industry.
- Ask the user probing questions to establish if they are motivated in their role, and if and why they learn.
- Craft questions that will help you understand the ways the user learns and how the user engages with learning. A good reference here is the [Bartle Taxonomy](https://en.wikipedia.org/wiki/Bartle_taxonomy_of_player_types); you can further validate by showing them the taxonomy afterward and asking them to self-identify.
- Ask the user to tell you about the last time they were onboarded to a product. Bear in mind that they will be telling you what they remember versus what actually happened, but it should still generate valuable insights about how they approach and incorporate learning. See the [peak-end rule](https://en.wikipedia.org/wiki/Peak%E2%80%93end_rule) to understand how the memory of an experience differs from the action experience.
...
The creation process for learning content is long and complex. Be sure to provide sufficient lead time for the content writer to understand each story, explore and draft, finalize the content, and get sign-off from stakeholders. The content writer often becomes the point of convergence between technical teams, product management, and design. They will have to do a lot of work to align the content to meet all of the needs, as well as get sign-off from their own chain of management and quality assurance. We are currently working on a content section that will provide support for content writers, including tips and tools for managing stakeholders, juggling feedback, and securing sign-off.
