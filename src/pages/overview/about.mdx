...
The **CD&AI Design pattern asset library** is an extension of the <a href=" https://www.carbondesignsystem.com/" target="_blank">Carbon design system <Launch16 fill="currentColor" style="vertical-align:middle; margin: 0 2px 2px 0"/></a>. 
...
The pattern asset library will:
