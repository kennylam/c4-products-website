---
title: Delivering changes
---

<PageDescription>

  This page describes how to set up your local environment and deliver code changes to the website.

</PageDescription>

<AnchorLinks>

<AnchorLink>Background information</AnchorLink>
<AnchorLink>One-time local environment setup</AnchorLink>
<AnchorLink>Making and delivering changes</AnchorLink>
...
internal Github Enterprise instance, here: <https://github.ibm.com/CDAI-design/pal>
...
(<https://travis.ibm.com/CDAI-design/pal/builds>)
...
[contributors](https://github.ibm.com/CDAI-design/pal/graphs/contributors) or those who have [recently submitted
commits](https://github.ibm.com/CDAI-design/pal/commits/master) to identify somebody active on the project.
...
This section describes the delivery dorkflow and how changes get published on the live site.

1. Open the local clone of the pal repository in VSCode.
...
7. Once the branch with the changes has been pushed up to the master
  ...
  a. Go to the master repository <https://github.ibm.com/CDAI-design/pal> and click on ‘Compare & pull requestʼ, which should
