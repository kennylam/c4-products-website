...
3. Now, make your first edits.
  ...
  a. In the left hand panel find and open the file `src/pages/overview/about.mdx`
...
4. To see the effect of your edits make sure the development server is running
  ...
  Open http://localhost:8000/overview/about in your browser and verify your changes. Continue
