...
<PageDescription>
  ...
  Step-by-step guides walk users through a specific task from beginning to end. As you build out these tours, consider where your users are along their journey. Think of the key tasks they'll need to complete to get to productive use on Day 1 and then any common activities they'll want to complete later on.
...
![UI Tours](images/WalkMe-overview-stepbystep.png)
...
* You can use popups within a Smart WalkThru to orient the user if they have moved to a new part of the UI or will be starting a new task
...
Visit the [ShoutOuts](/walkme-guide/shoutouts/usage) and [Smart WalkThru](/walkme-guide/smart-walk-thrus/overview) pages.
