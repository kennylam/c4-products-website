...
<PageDescription>
  ...
  Popups have multiple uses within a Smart Walk-Thru, we recommend using them to start a tour. Popups and ShoutOuts share the same styling and rules but they have different functionalities. A Popup can also be used within a Smart Walk-Thru to provide more context or host media, like videos.

</PageDescription>

#### Usage

* Use at the beginning of all tours and at the end of a Step-by-step guide 
* Use to provide more information that isn't directly anchored to part of the UI 
...
![Annotations start](images/annotations-start.png)
...
![Annotations end](images/annotations-end.png)
