...
![Styles](images/WalkMe-SWT-overview.png)
...
* [Steps](/walkme-guide/smart-walk-thrus/steps) that are components that point to specific elements in the UI or prompt the user to do something
* [Popups](/walkme-guide/smart-walk-thrus/popups) that are large modal components that appear in the center of the screen, unattached from UI elements. Within our current visual guidance, Popups and ShoutOuts follow the same style guidance.
