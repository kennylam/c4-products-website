...
In this initial stage, you and your team can set up a [WalkMe workshop](#walkme-workshops) to align around WalkMe concepts. The WalkMe workshop is flexible in timing and can be held before or after the WalkMe demo and kickoff calls. However, if the workshops are held too late in the process they will be less effective.
...
We've designed WalkMe components that complement our existing Carbon styling. So far, we've established the following component patterns:

- [Player menu](/walkme-guide/menu/usage) and launcher are your user's method to access and launch your WalkMe patterns.
...
The WalkMe workshops help you and your team kick off your getting started journey!
