...
<PageDescription>
  ...
  Players provide the user with an organized view of all of the Walkme content that's published. The labels within the Player should be clear and concise. They should speak to the tasks your users will accomplish or the things they will learn.
...
![Player themes](images/WalkMe-player-style-getstarted.png)
...
![Player themes](images/WalkMe-player-style-learnmore.png)
...
* Use the launch icon for resources
