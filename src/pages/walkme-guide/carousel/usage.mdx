...
The carousel can be used as a substitute for a Popup or ShoutOut. In order to implement an effective Carousel, you must first determine which [pattern](/walkme-guide/walkme-patterns/overview) your use case falls into. 
