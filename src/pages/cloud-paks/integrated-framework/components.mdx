...
<DoDont caption="If a data fragment is supplemental and not mandatory based on the configuration for the user or organization, hide the section and do not display an empty state.">
