...
4. **Text label:** Indicates what action will occur. The application name should not be included in the text label. Button labels should follow [Carbon text label guidance](https://www.carbondesignsystem.com/components/button/usage/#text-labels), using the {verb} + {noun} formula and leverage common [action labels](https://www.carbondesignsystem.com/guidelines/content/action-labels).
