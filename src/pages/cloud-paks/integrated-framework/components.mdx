...
2. **Content:** The content within the tearsheet is owned by an application or service. Through the tearsheet, content is surfaced within any app, anywhere on the platform to capture information and pass it back.
...
<DoDont caption="In the wide tearsheet, you can import a visualization, a table, or a full experience from another page, application, or service.">

![In the wide tearsheet, you can import a visualization, a table, or a full experience from another page, application, or service.](images/tearsheet-howto-2.jpg)
...
1. **Modal:** The modal can utilize default Carbon components or use a custom modal if the experience dictates it (like the example shown).
