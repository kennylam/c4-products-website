...
![Use the provided text to populate the page, depending on whether you can render the user's name and whether they have used the product before.](images/01b.png)

<Caption>Use the provided text to populate the page, depending on whether you can render the user's name and whether they have used the product before.</Caption>
 </Column>
</Row>

Follow the guidance in the table to write the copy for your landing page. 

| Name available | Use | Greeting | Locator | Summary |
|----------------|-----|----------|---------|---------|
|Yes|First-time|Hey Ginni!|Welcome to Product Name.| Short description of ~6 words.|
|No|First-time|Hello!|Welcome to Product Name.| Short description of ~6 words.|
|Yes|Returning-user|Hey Ginni, welcome back!|What will you achieve with Product Name today?| Short description of ~6 words.|
|No|Returning-user|Welcome back!|What will you achieve with Product Name today?| Short description of ~6 words.|
