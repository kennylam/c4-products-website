...
![Product header](images/CloudPakHeader.png)

### Anatomy

The Cloud Pak switcher consists of the following elements:

![Cloud Pak Switcher](images/CloudPakSwitcher.png)
...
![App switcher menu specs](images/Specs2.png)
...
![App switcher navigation](images/Navigation.png)
...
- [Sketch file](https://ibm.box.com/s/ihspsozyyirpv2wvtqwuagarvjgtr6vd)

- [Redline](https://ibm.box.com/s/g7evsy8oj5uxgrdju68qy6a163z5mfc0)