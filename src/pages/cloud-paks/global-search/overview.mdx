...
Global search is the primary search across all of Cloud Pak Platform that allows users to search for everything they have access to across the platform.
