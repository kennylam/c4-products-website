...
When the user is ready to buy, they can also work with an IBM seller to get a custom offer that better meets their needs. See [Custom offer via IBM Sales](https://pages.github.ibm.com/cdai-design/pal/plg-and-multicloud-saas/user-scenarios/private-offer) for details.
