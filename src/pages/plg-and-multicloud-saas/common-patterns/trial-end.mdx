...
<Breadcrumb>
  ...
  <BreadcrumbItem isCurrentPage href="https://pages.github.ibm.com/cdai-design/pal/plg-and-multicloud-saas/common-patterns/trial-end">
   Expired trial
  </BreadcrumbItem>
</Breadcrumb>
...
## Email communication
In addition to the in product experience, emails can also be sent directly to the user both prior to the expiry and when the trial has expired. See [email templates](https://pages.github.ibm.com/cdai-design/pal/plg-and-multicloud-saas/email-templates/) for details.
