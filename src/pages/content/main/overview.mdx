...
<AnchorLinks>
  ...
  <AnchorLink>Related education</AnchorLink>
...
## Related education
This content guidance is a reference resource that is intended to help IBMers find answers to specific 
content-related questions. It has been structured to aid quick retrieval of information by theme.

If you’d like to learn more about content design and how you can improve your product UX writing skills 
in a structured, modular education course, then do check out the following course (which has [an associated learning plan](https://yourlearning.ibm.com/activity/PLAN-EC0291D9A084) on the IBM Your Learning platform).
