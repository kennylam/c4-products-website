...
<InlineNotification>
Note: There is an open issue (<a href="https://github.com/carbon-design-system/carbon-website/issues/1276">here</a>) with the Carbon team about this current definition.
</InlineNotification>
...
<InlineNotification>
Note: There is an open issue (<a href="https://github.com/carbon-design-system/carbon-website/issues/1277">here</a>) with the Carbon team about this current definition.
</InlineNotification>
...
data through a series of mathematical steps (that is, algorithms). The model represents the steps an 
...
or "Delete" and so on). Use OK only when such a label is not available. Write as shown: two letters, both uppercase._
