...
IBM products should be using common Carbon components to build their UIs. This includes 
...
<InlineNotification>
Note that the location-based (that is, hierarchical) type of breadcrumb is the type used in nearly all cases across IBM Software offerings.
</InlineNotification>
...
- The Carbon for IBM Products <Link to="../../components/page-header/usage/">Page header</Link> component provides the following guidance: 
...
<DoDontRow>
  <DoDont text="Operator benefits" aspectRatio="1:1" />
  <DoDont text="What are the benefits of using operators?" type="dont" aspectRatio="1:1" />
</DoDontRow>

<DoDontRow>
  <DoDont text="Kubernetes cluster configuration" aspectRatio="1:1" />
  <DoDont text="How to best configure a Kubernetes cluster?" type="dont" aspectRatio="1:1" />
</DoDontRow>

<DoDontRow>
  <DoDont text="Trial duration" aspectRatio="1:1" />
  <DoDont text="When will my free trial end?" type="dont" aspectRatio="1:1" />
</DoDontRow>
...
### Using a side panel
The Carbon for IBM Products site offers a side panel, which is useful for scenerios where the user 
...
See the Carbon for IBM Products [Side panel](https://pages.github.ibm.com/cdai-design/pal/components/side-panel/usage) component for more details.
