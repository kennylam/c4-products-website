...
<DoDontRow>
  <DoDont text="Operator benefits" aspectRatio="2:1" />
  <DoDont text="What are the benefits of using operators?" type="dont" aspectRatio="2:1" />
</DoDontRow>

<DoDontRow>
  <DoDont text="Kubernetes cluster configuration" aspectRatio="2:1" />
  <DoDont text="How to best configure a Kubernetes cluster?" type="dont" aspectRatio="2:1" />
</DoDontRow>

<DoDontRow>
  <DoDont text="Trial duration" aspectRatio="2:1" />
  <DoDont text="When will my free trial end?" type="dont" aspectRatio="2:1" />
</DoDontRow>
