...
<BannerQuote
  quote="It’s not what you say, but how you say it."
  backgroundHighlight="#0043CE"
>

![Image](./images/illustrations/our-personality.svg)
...
- Input from Cloud for IBM Products designers, including feedback from workgroups, surveys, and a voice and tone design jam

If we had to summarize our profile in just a few brief words, we’d want to particularly highlight the following 
characteristics:
- Engaging
- Helpful
- Conversational
...
- **human** — sounds like a real person, not a machine (for example, uses some idioms and humor)
