...
| 3e | Where relevant, contextual help is provided (for example, through learning panels, WalkMe guides, and so on) so that users rarely need to navigate away from the product UI context. | > <Link to="../../components/onboarding/overview">Onboarding components</Link><br/>> <Link to="../../patterns/onboarding/overview">Onboarding patterns</Link> |
