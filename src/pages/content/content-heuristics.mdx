...
<AnchorLinks>
  ...
  <AnchorLink>5) Content fit and finish</AnchorLink>
</AnchorLinks>

## Overview
The following content heuristics are provided to help IBM teams develop engaging, user-centered 
content that is professional, consistent, and which helps our clients succeed. 

We've grouped the individual heuristics into 5 logical sections. These are the same 5 sections that are 
used to assess the **Content & Get Help** quality dimension within our product [D&UX program](https://pages.github.ibm.com/cdai-design/dux/) 
reviews.
