...
<DoDontRow>
  <DoDont text="Save changes?" aspectRatio="" />
  <DoDont text="Would you like to save changes?" type="dont" aspectRatio="" />
</DoDontRow>
...
<DoDontRow>
  <DoDont text="Please check the email address" aspectRatio="" />
  <DoDont text="You’ve entered an incorrect email" type="dont" aspectRatio="" />
</DoDontRow>
...
![Example UI showing text lines that are too long](images/text_line_length.png)
