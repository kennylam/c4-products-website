...
<DoDontRow>
  <DoDont text="Save changes?" aspectRatio="2:1" />
  <DoDont text="Would you like to save changes?" type="dont" aspectRatio="2:1" />
</DoDontRow>
...
<DoDontRow>
  <DoDont text="Please check the email address" aspectRatio="2:1" />
  <DoDont text="You’ve entered an incorrect email" type="dont" aspectRatio="2:1" />
</DoDontRow>
