...
<DoDontRow>
  <DoDont text="Support" aspectRatio="1:1" />
  <DoDont text="Getting support" type="dont" aspectRatio="1:1" />
</DoDontRow>

<DoDontRow>
  <DoDont text="Settings" aspectRatio="1:1" />
  <DoDont text="Configuring your settings" type="dont" aspectRatio="1:1" />
</DoDontRow>

<DoDontRow>
  <DoDont text="Appliance dashboard" aspectRatio="1:1" />
  <DoDont text="Appliance management and monitoring dashboard" type="dont" aspectRatio="1:1" />
</DoDontRow>
...
<DoDontRow>
  <DoDont text="User groups" aspectRatio="1:1" />
  <DoDont text="User Groups" type="dont" aspectRatio="1:1" />
</DoDontRow>
...
<DoDontRow>
  <DoDont text="Docs" aspectRatio="1:1" />
  <DoDont text="Docs." type="dont" aspectRatio="1:1" />
</DoDontRow>

<DoDontRow>
  <DoDont text="Preferences" aspectRatio="1:1" />
  <DoDont text="Preferences..." type="dont" aspectRatio="1:1" />
</DoDontRow>

<DoDontRow>
  <DoDont text="Users and groups" aspectRatio="1:1" />
  <DoDont text="Users & groups" type="dont" aspectRatio="1:1" />
</DoDontRow>
...
<DoDontRow>
  <DoDont text="Published apps" aspectRatio="1:1" />
  <DoDont text="Org settings" aspectRatio="1:1" />
</DoDontRow>

<DoDontRow>
  <DoDont text="Admin console" aspectRatio="1:1" />
  <DoDont text="Admin. console" type="dont" aspectRatio="1:1" />
</DoDontRow>

<DoDontRow>
  <DoDont text="KPI dashboard" aspectRatio="1:1" />
  <DoDont text="KPI dash" type="dont" aspectRatio="1:1" />
</DoDontRow>

<DoDontRow>
  <DoDont text="Kubernetes settings" aspectRatio="1:1" />
  <DoDont text="K8s settings" type="dont" aspectRatio="1:1" />
</DoDontRow>
