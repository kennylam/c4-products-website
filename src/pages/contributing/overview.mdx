...
Our design system flourishes when designers and developers contribute their assets so that everyone can benefit from them.

This contribution mindset framework provides a set of methods and tools to help you as you create and then share a new asset. The guidance covers the end-to-end process, from initial research, to the design, development and contribution phases.
...
Acommon mistake is to put off thinking about the possibility of contributing the new asset until after it has been designed and developed. By adopting a contribution mindset from the outset, you will likely save yourself a lot of work in the long run.
...
<Column colLg={6}>
<DoDontExample type="dont" caption="Do not postpone thinking about contributing your asset until theend of the project. Doing so will likely result in more re-work andultimately make successful contribution less likely.">
...
<Row>
  ...
  <Column colSm={2} colMd={4} colLg={3} noGutterSmLeft noGutterMdLeft noGutterLgLeft>
    ...
    >
      Get to know more about user need, existing resources, similar use cases, and sync with DSAG team
    </StepCard>
  </Column>
  <Column colSm={2} colMd={4} colLg={3} noGutterSmLeft noGutterMdLeft noGutterLgLeft>
    <StepCard
...
<ExpressiveOverview
  ...
  color="blue"
>
  <ExpressiveOverviewCard title="Team work">
...
Our value as an organization is rooted in our ability to create meaningful solutions and tools for our customers.
  ...
  <ExpressiveOverviewCard title="D&XU review scores" href="https://pages.github.ibm.com/cdai-design/dux/">
