...
and how these get proposed, designed, reviewed, and approved.

</PageDescription>

<InlineNotification kind="info">

For information about contributing to this microsite, the technical set-up required to build pages on your local machine, and how to then 
deliver those changes using the GitHub workflow, see the <Link to="/contributing/updating-this-site/overview">Updating this site</Link> section.
...
- [Guidance for contributing patterns](https://www.carbondesignsystem.com/how-to-contribute/pattern)
    - <Link to="/contributing/designing-components-patterns/markdown-reference">Markdown Reference page for best practices on using Markdown</Link>
