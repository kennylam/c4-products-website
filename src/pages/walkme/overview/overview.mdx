...
<PageDescription>
  ...
  In this PAL you can find information that covers [WalkMe patterns](/walkme/walkme-patterns/overview), [Design guidance](/walkme/overview/design), and [WalkMe components](/walkme/overview/overview#walkme-components).
...
- [Welcome pattern](/walkme/walkme-patterns/welcome-pattern) helps welcome your users to your product and best informs them of your product's values and capabilities. 
- [Overview pattern](/walkme/walkme-patterns/overview-pattern) introduces users to key links, features, actions, and elements of a page with multiple important UI components.
- [Task pattern](/walkme/walkme-patterns/task-pattern) guides and walks users through a specific task from beginning to end.


### Design guidance

From the [design guidance](/walkme/overview/design) you can find information on how to utilize the WalkMe Carbon template in the WalkMe editor.
...
- [Player menu](/walkme/menu/usage) and launcher are your users method to access and launch your WalkMe patterns.
- [ShoutOuts](/walkme/shoutouts/usage) are modals that are used to create your Welcome screen patterns.
- [Smart Walk-Thrus](/walkme/smart-walk-thrus/overview) are made up of Popups and Steps and are designed to help you create your UI tour and Step-by-step patterns.
...
If you need any help with the WalkMe workshop, reach out to the [Getting Started design team](/walkme/overview/contacts#getting-started-design-team) for guidance!
