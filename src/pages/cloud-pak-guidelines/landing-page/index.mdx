...
<Row>
 <Column colLg={8}>
  <div style="padding: 15px; border-left: 3px solid #054ada; background: #edf4ff; line-height: 1.5rem">
   <strong>Note:</strong> The page will be provided as a shareable, reusable component used
...
<Row>
 <Column colLg={8}>
  <div style="padding: 15px; border-left: 3px solid #054ada; background: #edf4ff; line-height: 1.5rem">
   <strong>Note:</strong> There should be a minimum of 2 large tiles on the page, preventing
