...
Full-page error is a v2 pattern, replacing the previous HTTP errors used in Carbon for IBM Products v1. <br /><br />
For products still on Carbon 10, refer to the [HTTP errors](https://pages.github.ibm.com/cdai-design/pal/patterns/http-errors/usage/) guidance for supported functionality.
