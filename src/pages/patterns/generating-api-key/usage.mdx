...
On the management page, keys are typically listed in a data table, using a
...
![An example of an Edit an API key workflow, which ends with a "save" action.](images/Edit.png)
