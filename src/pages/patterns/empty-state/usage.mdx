...
Additional guidelines here provide CD&AI Designers the header text and image in 4 key scenarios. 
Images are provided in the reusable components, but can be found along with the default text in the table. 

For errors that require a full screen takeover, orwhere none of the page content can be shown, please refer to the HTTP errors pattern. 
