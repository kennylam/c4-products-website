...
##### Two-line item
<Caption>
  {' '} A two-line item contains a label and a one-line description or a detail that helps the user distinguish items.
{' '}
</Caption>
