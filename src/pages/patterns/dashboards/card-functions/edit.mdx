...
The ability to move and resize cards is a distinct need for many users since quite often the location and proportions of the dashboard cards require editing.
...
In this section of the guidance, you'll find both mouse and keyboard-centric means of altering the shape and location of dashboard cards.
...
![moving cards](images/movingCards.gif)
...
![moving cards via keyboard](images/keyboardMoveCard.png)
...
![resizing cards](images/resizingCard.gif)
...
![resizing cards via keyboard](images/keyboardResizingCard.png)
