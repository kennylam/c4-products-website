...
The additive and destructive functions involved here will focus on the dashboard itself. This will include creating net new views, adding sections, or removing entire dashboards. Any sort of alteration of preexisting dashboards will fall under the perview of `Edit`.
