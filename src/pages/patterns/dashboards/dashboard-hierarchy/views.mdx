...
<Row>
  ...
  Use the `$layout-01` token to vertically space the areas directly below the tabs component and directly above the cards.

  ![page layout module](/images/views-layout.png) 
...
- Use to organize or categorize related cards and data. **Examples:** Dashboard title: "Continents". _View titles:_ Africa, Antarctica, Australia, Europe, North America, South America
...
- When creating views, consider how many you will have. If you foresee having an amount large enough that organization and navigation become cumbersome, consider how the views can be grouped or categorized and potentially create additional dashboards instead.
