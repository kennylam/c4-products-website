...
9. **Trademark and copyright information (_optional_):** Optionally include legal text. Suggested format for copyright - Copyright (c) 2018 Company
...
| 03. Link / Action                              |   `Body-short-01, link-01`  |    IBM Plex Sans, 14px |
| 04. Description                                |   `Text-03: Body-short-02`    |    IIBM Plex Sans (Regular) - 16px |
| 05. Version number / title                      |   `Text-01: Productive-heading-01`   |    IBM Plex Sans (semi-bold) - 14px |
| 07. Primary/secondary button(Button Component) |   `Text-01: Body-short-01`    |    IBM Plex Sans (Regular) - 14px |
