...
By default, we recommend each product to use the dark theme for their about modals as they are triggered from the About section within the profile menu in the main navigation. However, you may opt to choose the light version if this is a product requirement.
