...
| 04. Description                               |   `Text-02: Body-short-02`    |    IBM Plex Sans (Regular) - 16px |
...
Use [tabs](https://www.carbondesignsystem.com/components/tabs/usage) to display additional information that can help inform your users. For example, used to display technology requirements being used in your product.
