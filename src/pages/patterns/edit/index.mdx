...
4. If an item is not editable near other items that are, show the read-only (edit off) icon on hover. A tooltip should briefly state why it's locked. 
...
![Inline edit behavior](images/inline-edit608.gif)
...
![Anatomy modal](images/Edit-Modal-Anatomy.png)
...
needs to be edited. Refer to C&CS PAL Side Panel guidelines for available sizes and grids.
...
![Anatomy narrow tearsheet](images/Anatomy-Narrow-Tearsheet.png)
...
4. **Influencer (optional)**: A left or right side panel that can be used, for example,  as a menu, progress indicator, or filter. 
...
![Anatomy side panel](images/Full-page-edit-Anatomy.png)
