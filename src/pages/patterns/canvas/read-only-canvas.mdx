...
Icon and text will vertically- and center-align to the badge.
...
<Caption>
  ...
  "Read-only" badge appears when a user doesn't have permissions to edit a particular file but still has the ability to view it.
...
![Locked badge](images/readOnly-BadgeVariantLocked.png)
  ...
  "Locked" badge appears when a user is editing a file but another user accesses that file. 
...
These tooltips can be either accessed upon hovering over or focusing on the badge.
