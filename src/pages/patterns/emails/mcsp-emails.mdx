...
Emails provide a way to asynchronously communicate with users outside of the product.
...
Product teams can use emails to communicate with users about their Try offer or paid subscriptions. Emails should be sent only when necessary. Use the following patterns if your product is on the [MultiCloud SaaS Platform](https://w3.ibm.com/w3publisher/multicloud-saas-platform) (MCSP).
...
![Email template](images/mcsp-emails/emailAnatomy.png)
...
<Row>
  ...
  <AccordionItem title="Profile email - Verify your IBM email change request">This email is sent to the new email address when a change to the user's IBMid or contact email address is requested on ibm.com.

<Row>

</Row>
  </AccordionItem>
  <AccordionItem title="Profile email - Your IBM email change">This email is sent to the existing email address when a change to the user's IBMid or contact email address is requested on ibm.com.

<Row>

</Row>
  </AccordionItem>
  <AccordionItem title="Profile password - Your IBM password is expiring">This email is sent when the user's IBM password is expiring within the specified number of days.

<Row>

</Row>
  </AccordionItem>
  <AccordionItem title="Profile password - Your IBM password has expired">This email is sent when the user's IBM password has expired.

<Row>

</Row>
  </AccordionItem>
  <AccordionItem title="User profile - Your IBM profile has been updated">This email is sent when the user's IBM profile has been updated.
...
![SendGrid](images/mcsp-emails/sendGrid.png)
