...
![Email notice of updated profile](images/ibmid-emails/account-ibmid-updated.png)
...
When triggered by a completed change to their IBMid password, this email is sent to the user's IBM contact email address. The email
alerts them to their updated profile.
