...
title: IBM PLG transactional email footer
...
IBM email services that send transactional emails to customers can align with the IBM PLG standard by implementing the PLG transactional email footer. This page provides details on this email footer and the HTML code snippet.
...
The **IBM PLG transactional email footer** is a research-based UX design which meets legal requirements and provides an optimal user 
...
The PLG transactional email footer, included in all Try offer transactional emails, covers IBM legal requirements and provides links 
to recommended legal information:   
...
The PLG transactional email footer is also shown in the following Try offer Welcome email:
