...
to recommended legal information. The text and links used in the footer are as follows: 

(Start transactional email footer)
...
(End transactional email footer content)
...
<iframe class="airtable-embed" src="https://airtable.com/embed/appvxykrpLizynCkz/pagPWyrSrvFIa8dhk/form" frameborder="0" onmousewheel="" width="100%" height="600" style="background: transparent; border: 1px solid #ccc;"></iframe>
