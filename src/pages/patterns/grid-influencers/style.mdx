...
## Wide tearsheet grid
A tearsheet is a mostly full-screen type of dialog that keeps users in-context and focused by bringing actionable content front and center while revealing parts of the UI behind it. The large tearsheet has a separate grid from the page-level grid because it only covers a portion of the page.
