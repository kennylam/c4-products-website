...
### Padding
The expandable area should have the following padding. The padding remains the same regardless of the height of the table's rows.
...
### When not to use
When the content in the expanded area begins to feel cramped, consider using a dedicated page, sidebar, modal, or tearsheet to view information and complete tasks. 

*If my content is feeling cramped, can I  increase the expandable area's height?*
...
This is an example of how Watson Knowledge Catalog displays additional row information. Instead of opening an expanded row area, the additional information is placed in a side panel.

![Watson Knowledge Center](images/expandable-row-watson-knowledge-center.png)
...
#### *Why can't I align my content to the grid?*
...
#### *Can I align content to the table columns?*
...
### Wrapping
In a responsive data table, the items in the expanded area may run out of space. If this happens you can consider wrapping the items or displaying the expanded content in a different manner.

If you choose to wrap items make sure that the information in the expanded area is still usable and that important relationships between content are preserved.

*Add an example of wrapping here*

You should not wrap content if the table has a horizontal scroll bar or a fixed width.
...
## Examples
![Code and Tag Manager](images/expandable-row-code-tags.png)
![Resource Usage](images/expandable-row-resource-usage.png)
