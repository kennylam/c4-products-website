...
_If my content is feeling cramped, can I  increase the expandable area's height?_
...
Here is an example of how you can wrap from one of the previous examples.

![Example of how to wrap content in an expanded area.](images/expandable-row-wrapping-do-load-balancer.png)

The following is an example of how not to wrap items in an expanded area. The _Provision Status_ section's placement bisects the *Details* section in a way that makes it difficult to tell that the *Details* section contains key value pairs.
