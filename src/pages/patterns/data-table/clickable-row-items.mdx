...
<Breadcrumb>
  ...
  <BreadcrumbItem isCurrentPage href="/patterns/data-table/clickable-row-items">
    Column Alignment
  </BreadcrumbItem>
</Breadcrumb>
...
Action icons in single table rows should also contain the action “_View details_”. If the user selects the action the side panel is launched. See guidance: [Row action buttons](https://pages.github.ibm.com/cdai-design/pal/patterns/data-table/row-action-buttons/)
...
- [C&CS Table row action buttons](https://pages.github.ibm.com/cdai-design/pal/patterns/data-table/row-action-buttons/)
- [C&CS Additional tag features](https://pages.github.ibm.com/cdai-design/pal/components/additional-tag-features/)