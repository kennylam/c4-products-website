---
title: Data table
path:  /patterns/data-table/overview
subpage:
    title: Data table row actions
    path: /patterns/data-table/row-actions
---
...
_Note: Action buttons and overflow menus are not interchangeable in terminology and are refereed to as 2 different components in this document. [Action buttons](https://www.carbondesignsystem.com/components/button/usage) (rather icon action buttons) are buttons that use icons to instantiate an action or lead to a flow via a dialog. [Overflow menus](https://www.carbondesignsystem.com/components/overflow-menu/usage) always use the "..." icon to indicate multiple items are available._
