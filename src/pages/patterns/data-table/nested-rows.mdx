...
<br></br>
<Aside>
Consider using a different pattern if your table needs more than four levels of nesting. As nesting goes into multiple sublevels, the size of the column reduces.
</Aside>
</Column>
...
- [Expanded rows](https://pages.github.ibm.com/cdai-design/pal/patterns/data-table/expandable-rows)
