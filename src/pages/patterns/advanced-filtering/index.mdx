...
This addition to the [filtering pattern in Carbon](https://www.carbondesignsystem.com/patterns/filtering) provides _advanced filtering_ in the _selecting filters_ subsection. 
