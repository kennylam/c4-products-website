...
Through all [universal experiences](https://w3.ibm.com/design/experience-standards/universal-experiences/overview/introduction) from discovery to end use, users are informed and guided, build relationships, and make decisions with us. Onboarding is a key opportunity to provide our users with great first impressions by introducing meaningful product value through several stages of their engagement.

</PageDescription>

<AnchorLinks>
   <AnchorLink>Primary onboarding</AnchorLink>
   <AnchorLink>Secondary onboarding</AnchorLink>
   <AnchorLink>Tertiary onboarding</AnchorLink>
...
<CardGroup><MiniCard
  title="More about sandbox trials"
  href="https://pages.github.ibm.com/security/security-design/department/end-to-end-experiences/sandbox-trial/overview"
  />
</CardGroup>
