...
- Please refer to the [Profile image](https://pages.github.ibm.com/cdai-design/pal/patterns/user-profile-images/usage) pattern on Carbon for more details. 
...
Required
- User's profile image. Please refer to the [Profile image](https://pages.github.ibm.com/cdai-design/pal/patterns/user-profile-images/usage) pattern for more details. 
- User's full name. 
...
Variations
- If no user photo is available, the thumbnail displays the user's initials. Please refer to the [Profile image](https://pages.github.ibm.com/cdai-design/pal/patterns/user-profile-images/usage) pattern for more details. 
