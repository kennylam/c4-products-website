...
![The user enters the resource name in order to confirm deletion.](images/HighImpactDeleteModal-1.png)
...
![When the resource name is entered the Delete button is enabled.](images/HighImpactDeleteModal.png)
...
When deleting a resource that has connected items, users will enter the name of the resource in the text field and use the checkbox to confirm the deletion the all its connected items. 
...
![Deletion with connected items](images/Connectdelete.png)
...
- The name of the items that are connected to the main resource that is hindering its deletion

<Row>
<Column colLg={8}>

![Manual deletion of connected items](images/ManualDel.png)
...
![Batch deletion](images/Batch1.png)
...
![Batch deletion](images/Batch2.png)
...
**Do's**
- Always include the name of the resource, the consequences of the deletion, the phrase, "this action cannot be undone", and an editable text field for the name of the resource to be entered.
...
![Dont example](images/DontExample-1.png)

<Caption>Don't examples</Caption>

</Column>
<Column colMd={2} colLg={4}>

![Dont example](images/DontExample-2.png)

</Column>
<Column colMd={2} colLg={4}>

![Dont example](images/DontExample-3.png)
...
![Example of a medium impact delete modal](images/MediumImpactDelete.png)
...
![Example of a medium impact remove modal](images/MediumImpactRemove.png)

<Caption>
  {' '}
  Removal modals should include consequences of removal, and a "This action cannot
  be undone" statement.
</Caption>
...
![Example of a successful delete notification](images/UpdatedToastNotification.png)
