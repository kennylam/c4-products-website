...
<div className="glossary">
  <ul className="glossary-nav glossary-nav--fixed col1">
    <li className="glossary-nav__item bx--list__item"><a href="#a">A</a></li>
    <li className="glossary-nav__item bx--list__item"><a href="#b">B</a></li>
    <li className="glossary-nav__item bx--list__item"><a href="#c">C</a></li>
    <li className="glossary-nav__item bx--list__item"><a href="#d">D</a></li>
    <li className="glossary-nav__item bx--list__item"><a href="#e">E</a></li>
    <li className="glossary-nav__item bx--list__item"><a href="#f">F</a></li>
    <li className="glossary-nav__item bx--list__item"><a href="#g">G</a></li>
    <li className="glossary-nav__item bx--list__item"><a href="#h">H</a></li>
    <li className="glossary-nav__item bx--list__item"><a href="#i">I</a></li>
    <li className="glossary-nav__item bx--list__item"><a href="#l">L</a></li>
  </ul>
  <ul className="glossary-nav glossary-nav--fixed col2">
    <li className="glossary-nav__item bx--list__item"><a href="#m">M</a></li>
    <li className="glossary-nav__item bx--list__item"><a href="#n">N</a></li>
    <li className="glossary-nav__item bx--list__item"><a href="#o">O</a></li>
    <li className="glossary-nav__item bx--list__item"><a href="#p">P</a></li>
    <li className="glossary-nav__item bx--list__item"><a href="#r">R</a></li>
    <li className="glossary-nav__item bx--list__item"><a href="#s">S</a></li>
    <li className="glossary-nav__item bx--list__item"><a href="#t">T</a></li>
    <li className="glossary-nav__item bx--list__item"><a href="#u">U</a></li>
    <li className="glossary-nav__item bx--list__item"><a href="#v">V</a></li>
    <li className="glossary-nav__item bx--list__item"><a href="#w">W</a></li>
  </ul>
</div>
