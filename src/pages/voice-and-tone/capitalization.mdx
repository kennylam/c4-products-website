...
| check box      | **Verb:** Use _check_ to refer to selecting the choice. Use _clear_ to refer to deselecting the choice.<br/><br/>**Label:** Refer to the check box by its label followed by _check box_. | To enable email notifications check the Notify me check box.<br/><br/>To stop receiving email notifications, clear the Notify me check box. |
