...
UI buttons are not the place to express your unbounded creativity. Check the [Terminology](terminology) section to ensure you are using standard button labels.
...
(see the [Terminology](terminology) section for details) and then used consistently throughout.