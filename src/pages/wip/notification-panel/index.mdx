...
<InlineNotification kind="warning">
  ...
  Please note that notifications will shortly become a service provided to cloud paks by the Bedrock service. As such, this work in progress pattern will soon be replaced by documentation on this reuseable component. Contact Maui Francis for more information. 
...
### (View all) full-page centre

By default, the panel scrolls to contain all of the current notifications.  
If the offering also has a full-page notifications viewer, the notification panel may include a "View all" link to open it. This may be useful if the user has too many notifications to fit easily within the side panel as well as providing further search and filtering functionalities.
...
![Example of a full page notifications view.](images/08.png)
<Caption>Example of a full page notifications view.</Caption>
  </Column>
</Row>
...
If there are notification settings available to the user, a link to them can be included in the panel.   
This can be accessed from the settings icon at the bottom of the side panel.  
Depending on the amount of notification settings available, these would open up within the side panel, or launch the user to a full page settings.
...
![An example of notification settings in a full page.](images/09.png)
<Caption>An example of notification settings in a full page.</Caption>
  </Column>
</Row>