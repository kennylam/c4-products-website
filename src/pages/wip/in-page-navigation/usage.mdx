...
<AnchorLinks>
  ...
  <AnchorLink>In-product examples</AnchorLink>
...
### In-product examples
A non-exhaustive list of examples of the in-page navigation from products.

<Row>
 <Column colLg={8}>

![In-page navigation is used to navigate project management content in Watson Studio.](images/WatsonStudioProjectExample.png)
<Caption>In-page navigation is used to navigate project management content in Watson Studio.</Caption>
...
![In-page navigation is used to navigate new assets in Watson Studio.](images/WatsonStudioTearsheetExample.png)
<Caption>In-page navigation is used to navigate new assets in Watson Studio.</Caption>
...
![In-page navigation is used in the Create flow in IBM Cloud Pak for Integration.](images/CP4IExample.png)
<Caption>In-page navigation is used in the Create flow in IBM Cloud Pak for Integration.</Caption>
...
![In-page navigation is used in IBM Cloud Pak for Integration - IBM Event Streams.](images/EventStreamsExample.png)
<Caption>In-page navigation is used in IBM Cloud Pak for Integration - IBM Event Streams.</Caption>
