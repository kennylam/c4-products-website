...
This documentation is a set of guidelines on how to implement these component to ensure a consistent experience across the portfolio and provide users with a similar, uniform experience.
...
When providing the user with links from a data tables this should be using [standard link compnent](https://www.carbondesignsystem.com/components/link/code) in the first column of the data table.
...
<Caption>Do not use the whole role as a clickable element.</Caption>f
 </Column>
