...
This area is for significant actions the user needs to take within the sidebar; they are useful in creating, editing, and confirming use cases. The primary actions will always remain visible to the user.
...
Slide-in panels influence the page layout grid; below are the specifications for _panel combinations_ and how they impact the grid at all sizes. For more information about the 2x grid visit [Carbon's guidelines](https://www.carbondesignsystem.com/guidelines/2x-grid/overview).
