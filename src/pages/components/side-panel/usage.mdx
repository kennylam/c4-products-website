...
This area is for significant actions the user needs to take on within the side panel; they are useful in creating, editing, and confirmation use-cases. The primary actions will always remain visible to the user.
...
**Default**<br />
By default, the resizable panel does not have a visible resizable border which allows the user to focus more on other more important components on the interface.
...
For vertical panels, the user can use left and right arrow keys to resize the panel. For horizontal panels, the user can use the up and down arrow keys to resize the panel.
