...
### Further guidance
For further content guidance, see [Carbon’s content guidelines](https://www.carbondesignsystem.com/guidelines/content/overview/) and [Carbon for Cloud & Cognitive content guidelines](https://pages.github.ibm.com/cdai-design/guidance/voice-and-tone/).
...
_See [style section](https://pages.github.ibm.com/cdai-design/pal/components/side-panel/style) for theme color token specifications._

### Overlay backgorund usage (optional)
<Row>
<Column colMd={8} colLg={8}>
...
- [UI Shell left panel](https://www.carbondesignsystem.com/components/UI-shell-left-panel/usagel)
