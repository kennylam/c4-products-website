...
The recommendation is for panels triggered by the main page content to use the light theme. Panels triggered from the global navigation should use the dark theme. 

### Dark Theme (Triggered by the global navigation)
