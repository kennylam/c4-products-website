...
Please note: the percentage should count up as the bar progresses, not simply stay at 100%.
...
| Type    | Size   | Track size | Percentage location (optional) |
| ------- | ------ | ---------- | ------------------------------ |
| Spinner | Large  | 8px        | Inside the spinner             |
| Spinner | Small  | 4px        | To the right of the spinner    |
| Bar     | Large  | 8px        | Below, on the right edge       |
| Bar     | Small  | 4px        | Below, on the right edge       |
