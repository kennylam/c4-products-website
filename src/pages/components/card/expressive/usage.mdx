...
- Media can include pictograms, illustration, photography or videos. For information on illustration use see [Carbon for Cloud & Cognitive guidance](https://pages.github.ibm.com/cdai-design/pal/illustrations/usage).
