...
<Breadcrumb>
  ...
  <BreadcrumbItem isCurrentPage href="/components/data-table/expandable-rows">
    Expandable rows
  </BreadcrumbItem>
</Breadcrumb>
...
In the _do_ example all of the items in the expanded area wrap to one column. This prevents the _Provision Status_ section's placement from bisecting the _Details_ section in a way that makes it difficult to tell that the _Details_ section contains key value pairs.
