...
Inline editing in a data table allows a user to edit the contents of cells inline. This may include editing support for all fields or only a subset. Editing is done inline and in-context to enable quick changes. Inline editing includes editing data types such as text, numbers, and dates or selecting a value in a dropdown menu.
...
![Example of Auto save feature during Inline editing](../images/inline_editing_auto_save.png)
...
- When the data can't be edited inline and it requires a special interface such as having more than one input field. Use a [transactional modal](https://www.carbondesignsystem.com/components/modal/usage/#transactional-modal) or a [tearsheet](https://pages.github.ibm.com/cdai-design/pal/components/tearsheet/usage/) to edit the changes in, but still follow the hover states for inline editing.
...
A complex cell may have one or more clickable links in one cell.
...
4 data types that can be edited directly inside the data table.
...
![The four data types](../images/datatype_hover.jpg) 
...
![Example of a default data type](../images/data_type_default.png)
...
![Example of selection data type](../images/data_types4.png)
...
![Example of date data type](../images/data_types5.png)
...
![Example of number input without steppers data type](../images/data_types6.png)

<Caption>
  Number without steppers
</Caption>

  </Column>
  <Column colMd={3} colLg={3}>

![Example of number input with steppers data type](../images/data_types7.png)
...
When a column has been resized to a compact size where the cells are truncated, if the user clicks on the cell to activate edit mode, the cell will expand the width of the longest value in that column with a max-width of 40rem (640px). Once the user has saved the changes they have made to the cell, it will revert to the column size it was before editing.

When editing a compact column, the column will resize. Once the user has finished editing the data, the column width will revert to its original width.
...
![Example of a compact column interaction](../images/06_CompactColumns-01.gif)

![Example of a compact column interaction](../images/06_CompactColumns-01.png)
...
![Example of compact column interaction](../images/06_CompactColumns-02.png)
...
![Example of overflow content interaction](../images/07_OverflowContent-01.png)
...
Input validation is communicated in the active cell and an error state. If an error is present, the user won't be able to confirm their change with Enter or Tab. The user will need to enter the valid input for the error to disappear.
...
![Example of a cell validation interaction](../images/08_Validation-01.gif)

![Example of a cell validation interaction](../images/08_Validation-01.png)
...
![Example of a system error](../images/system_errors.png)
...
![Cell structure](../images/09_CellStates_Structure-02.png)
...
The hover state of a row that is selected with editable cells has a different hover state style. The hover state style is a border on the row in `$ui-05`.

<Row>
  <Column colMd={8} colLg={8}>

![Rows with selection (checkbox)](../images/09_CellState_Stucture-03.png)
...
![Complex cell states](../images/complex_cell_states.png)
...
![Cell state structure](../images/09_CellStates_Structure-05.png)
...
![Row sizes](../images/10_RowSizes-01.png)
