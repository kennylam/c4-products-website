...
#### Truncation
When truncation is enabled, text will truncate at one line instead of line wrapping. Once any column hits it's minimum width, the table will start to horizontal scroll. 
...
The CDAI table is coded to display a scrollbar on table hover to indicate the presence of additional scrollable content. Avoid adding extra elements such as floating action buttons, dropshadows, and scrollable gradients. Frozen columns should have a simple 1px border `$active-light-ui`.
...
- Table tool icons go under combo button
- Table button CTA or CTAs go in "important" section under line 


**Filters and settings at mobile**
![Image](./images/image_mobile2.png)

- Items like filter and settings takeover screen


## Accessibility 

Table row actions and toolbar items work the same in these responsive formats as they do at desktop view.
