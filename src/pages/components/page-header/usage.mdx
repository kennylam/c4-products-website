...
6. **Actions (optional):** This zone is for placing critical page actions. While this zone is primarily for actions, the specific type of component is left to product team discretion to meet user experience needs. Some examples of appropriate components within the action zone would be buttons, dropdowns, overflow menus...
