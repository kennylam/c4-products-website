...
The text bar respects the standard interactions used for Button component. Most of icon set has 5 interaction state (enabled, hover, focus, active and disabled). The typeface and size selections adopt the **Inline dropdown** component. Differently, the text color selection has a palette and the text alignment selection displays a contextual sub-bar.
