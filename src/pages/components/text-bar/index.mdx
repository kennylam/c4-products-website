...
![Example of standard and advanced text bar with responsiveness](images/GeneralGuidance.png)

## Anatomy

![Advanced text bar functionalities](images/Anatomy.png)
...
![Typing a message with the numbered list enabled](images/CommonUseCases.png)
...
#### Sketch file
[Download the Sketch file](https://ibm.box.com/s/s6sr1jazsqxwdvlkscfutqy04skxxn40)
