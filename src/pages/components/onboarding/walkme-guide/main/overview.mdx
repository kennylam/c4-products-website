...
<PageDescription>
  ...
  IBM uses a third-party tool called [WalkMe](https://www.walkme.com/) to deploy onboarding and support experiences. WalkMe also provides analytics, reporting, and session replays (for both WalkMe and the overall offering), which gives teams the opportunity to gain a comprehensive understanding of offering usage and data.
...
<CardGroup>
  <MiniCard
    title="WalkMe components"
    href="/components/onboarding/overview#walkme-components"
