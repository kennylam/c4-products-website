...
The influencers can be used for, but not limited to, the following situations. Use these to guide your work.
...
Often used for previewing what contents are selected from a view (typically a table that cannot reveal all selections without scrolling or hiding content).
