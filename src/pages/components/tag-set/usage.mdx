...
The tag set component allows users to see all the labels of a cluster in areas where all tags may not be visible at one time. They provide the ability to see how many additional labels exist and what they are.
...
- Do not use 1 “additional tag” in place of putting any tags
- Do only use this component when there is absolutely no space

**Other use cases**
The example shown is of a table with not enough space to show all the tags. However, this component can be used outside of a table as well. The use of the “additional tag” is solely dependent on the amount of space available.
