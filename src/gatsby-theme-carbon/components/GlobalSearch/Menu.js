// START COPY FROM https://github.com/carbon-design-system/gatsby-theme-carbon/blob/main/packages/gatsby-theme-carbon/src/components/GlobalSearch/Menu.js
...
const MenuItem = ({ page, index, onKeyDown, id }) => {
  ...
  return (
    <li role="none" key={page.name + page.path}>
      <Link
        onClick={onclick}
        onKeyDown={onKeyDown}
        tabIndex="-1"
