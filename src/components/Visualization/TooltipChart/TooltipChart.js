      ...
      <div className={`chart ${chartContainerHasFocus ? 'chart-with-focus' : ' '}`} tabIndex="0">
        ...
        <div className="chart--bars">
          <svg xmlns="http://www.w3.org/2000/svg" aria-labelledby="chart-title chart-desc" aria-details="det" viewBox="-13 -27 1251 800" className={isLoading ? 'barsLoading' : 'showBars'}>
            ...
            <g id="blue--ai" stroke={businessUnits['hps'].color}>
              <path tabIndex={focusIndex.current === 26 ? 0 : -1} aria-describedby="tooltip" id="hps--watson-discovery" onMouseMove={(e) => updateTooltipPosition(e)} onMouseEnter={(e) => showToolTip(e)} onMouseLeave={(e) => hideTooltip(e)} d="M842.268 576.29 743.895 331.459"/>
              <path tabIndex={focusIndex.current === 27 ? 0 : -1} aria-describedby="tooltip" id="hps--watson-assistant" onMouseMove={(e) => updateTooltipPosition(e)} onMouseEnter={(e) => showToolTip(e)} onMouseLeave={(e) => hideTooltip(e)} d="M817.901 585.485 730.015 336.723"/>
              <path tabIndex={focusIndex.current === 28 ? 0 : -1} aria-describedby="tooltip" id="hps--surveillance" onMouseMove={(e) => updateTooltipPosition(e)} onMouseEnter={(e) => showToolTip(e)} onMouseLeave={(e) => hideTooltip(e)} d="M793.166 593.637 715.922 341.387"/>
              <path tabIndex={focusIndex.current === 29 ? 0 : -1} aria-describedby="tooltip" id="hps--safer-payments" onMouseMove={(e) => updateTooltipPosition(e)} onMouseEnter={(e) => showToolTip(e)} onMouseLeave={(e) => hideTooltip(e)} d="M768.107 600.733 701.641 345.445"/>
              <path tabIndex={focusIndex.current === 30 ? 0 : -1} aria-describedby="tooltip" id="hps--planning-analytics" onMouseMove={(e) => updateTooltipPosition(e)} onMouseEnter={(e) => showToolTip(e)} onMouseLeave={(e) => hideTooltip(e)} d="M742.769 606.758 687.201 348.892"/>
              <path tabIndex={focusIndex.current === 31 ? 0 : -1} aria-describedby="tooltip" id="hps--open-pages" onMouseMove={(e) => updateTooltipPosition(e)} onMouseEnter={(e) => showToolTip(e)} onMouseLeave={(e) => hideTooltip(e)} d="M717.198 611.703 672.625 351.713"/>
              <path tabIndex={focusIndex.current === 32 ? 0 : -1} aria-describedby="tooltip" id="hps--investigative" onMouseMove={(e) => updateTooltipPosition(e)} onMouseEnter={(e) => showToolTip(e)} onMouseLeave={(e) => hideTooltip(e)} d="M691.441 615.558 657.943 353.919"/>
              <path tabIndex={focusIndex.current === 33 ? 0 : -1} aria-describedby="tooltip" id="hps--insurance-claim-fraud" onMouseMove={(e) => updateTooltipPosition(e)} onMouseEnter={(e) => showToolTip(e)} onMouseLeave={(e) => hideTooltip(e)} d="M665.543 618.317 643.18 355.494"/>
              <path tabIndex={focusIndex.current === 34 ? 0 : -1} aria-describedby="tooltip" id="hps--due-diligence" onMouseMove={(e) => updateTooltipPosition(e)} onMouseEnter={(e) => showToolTip(e)} onMouseLeave={(e) => hideTooltip(e)} d="M639.552 619.973 628.363 356.446"/>
              <path tabIndex={focusIndex.current === 35 ? 0 : -1} aria-describedby="tooltip" id="hps--commercial-payments" onMouseMove={(e) => updateTooltipPosition(e)} onMouseEnter={(e) => showToolTip(e)} onMouseLeave={(e) => hideTooltip(e)} d="M613.513 620.526 613.519 356.783"/>
              <path tabIndex={focusIndex.current === 36 ? 0 : -1} aria-describedby="tooltip" id="hps--cognos" onMouseMove={(e) => updateTooltipPosition(e)} onMouseEnter={(e) => showToolTip(e)} onMouseLeave={(e) => hideTooltip(e)} d="M587.475 619.972 598.672 356.496"/>
              <path tabIndex={focusIndex.current === 37 ? 0 : -1} aria-describedby="tooltip" id="hps--alert-insights" onMouseMove={(e) => updateTooltipPosition(e)} onMouseEnter={(e) => showToolTip(e)} onMouseLeave={(e) => hideTooltip(e)} d="M561.483 618.314 583.85 355.586"/>
            </g>
