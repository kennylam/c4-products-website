const businessUnits = {
    ...
    "Public Cloud Platform": {
        color: "#c2e5fe", //light blue
        id: "cloud--light-blue",
        products: {
            "public-cloud--platform" : {
                d: "M495.1 634.6 550.7 377",
