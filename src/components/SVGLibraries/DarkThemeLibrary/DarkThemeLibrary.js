...
const DarkThemeLibrary = () => {
    ...
    const {
      ...
      return (
        <Pictogram handleChange={handleChange} searchResults={searchResults} site={site} sectionRef={sectionRef} containerIsVisible={containerIsVisible} files={files} themedResources={allDarkThemeResourcesJson} />
      );
