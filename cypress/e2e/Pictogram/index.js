...
xdescribe("Test illustrations 'Light' theme library", () => {
...
describe("Test illustrations 'Dark' theme library", () => {
  ...
  xit('should find the Dark themed "Airport" image exists', () => {
    cy.findByAltText(/dark illustration of an airport/i).should("exist");
  });

  xit('should check if the Dark themed "Airport" image is visible', () => {
    cy.findByAltText(/dark illustration of an airport/i).should("be.visible");
  });

  xit("should check if all dark images have an alt and src attribute", () => {
  ...
  xit('should test "Dark" tab input field and type "truck" ', () => {
  ...
  xit("should check if first image in Pictogram has been removed", () => {
